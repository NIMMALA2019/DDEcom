...
public class ErrorMessage {
    ...
    public static final String LOGIN_USER_NOT_FOUND = "User not found or In-active";
    ...
    public static final String CATEGORY_INDEX = "Category Not found";
    
    public static final String ERROR_MSG = "Something went worng. Please try later....";
    
    public static final String IMAGE_CAT_INDEX = "Category Image Not found";
